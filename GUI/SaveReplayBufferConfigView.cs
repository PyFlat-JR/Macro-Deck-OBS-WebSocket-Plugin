...
namespace SuchByte.OBSWebSocketPlugin.GUI
{
    public partial class SaveReplayBufferConfigView : ActionConfigControl
    {
        ...
        public SaveReplayBufferConfigView(
        ...
        )
        {
            ...
            {
                config = JObject
                    .Parse(pluginAction.Configuration)
                    .ToObject<SaveReplayBufferConfig>();
        ...
        public override bool OnActionSave()
        {
            ...
            var config = JObject.FromObject(
                new SaveReplayBufferConfig { ConnectionName = selectedConnection.ToString() }
            );
